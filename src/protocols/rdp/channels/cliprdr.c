 ...
 */
static void guac_rdp_cliprdr_channel_connected(void* context,
 ...
 *     reference to the associated plugin loaded for that channel by FreeRDP.
 */
static void guac_rdp_cliprdr_channel_disconnected(void* context,
