 ...
 */
static void guac_rdp_disp_channel_connected(void* context,
        const ChannelConnectedEventArgs* args) {
    ...
    guac_rdp_disp_set_size(guac_disp, rdp_client->settings,
            rdp_context->instance, guac_rdp_get_width(rdp_context->instance),
            guac_rdp_get_height(rdp_context->instance));
 ...
 *     reference to the associated plugin loaded for that channel by FreeRDP.
 */
static void guac_rdp_disp_channel_disconnected(void* context,
        const ChannelDisconnectedEventArgs* args) {
...
void guac_rdp_disp_load_plugin(rdpContext* context) {
    ...
    PubSub_SubscribeChannelConnected(context->pubSub,
        guac_rdp_disp_channel_connected);

    /* Subscribe to and handle channel disconnected events */
    PubSub_SubscribeChannelDisconnected(context->pubSub,
            guac_rdp_disp_channel_disconnected);
