 ...
 */
static void guac_rdp_rail_channel_connected(void* context,
    ...
    ((rdpContext*) context)->update->window->WindowUpdate = guac_rdp_rail_window_update;
...
void guac_rdp_rail_load_plugin(rdpContext* context) {
    ...
    PubSub_SubscribeChannelConnected(context->pubSub,
            guac_rdp_rail_channel_connected);
